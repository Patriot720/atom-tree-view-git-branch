...
document.registerElement('tree-view-git-branch', {
    ...
    prototype: Object.assign(Object.create(HTMLElement.prototype), {
        createdCallback() {
            this.classList.add('list-item', 'entry');
        ...
        initialize({
            ...
            atom.commands.add('.tree-view', {
                ['tree-view:open-selected-entry'](e) {
                    var selected = e.target.querySelector('.selected')
                    if (selected.getAttribute('is') == 'tree-view-git-branch') {
                        selected.checkout();
                    }
                }
            })
